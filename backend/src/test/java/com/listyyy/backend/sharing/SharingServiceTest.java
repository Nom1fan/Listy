...
class SharingServiceTest {
    ...
    void invite_adds_list_member_and_auto_shares_categories_used_by_list() {
        ...
        ArgumentCaptor<com.listyyy.backend.productbank.CategoryMember> memberCaptor =
                ArgumentCaptor.forClass(com.listyyy.backend.productbank.CategoryMember.class);
